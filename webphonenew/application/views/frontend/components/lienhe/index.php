...
<section>
	<div class="container">
		<div class="col-md-7 col-12">
			<div class="section-article contactpage" style="  padding-left: 20px;">
				...
				<form accept-charset="UTF-8" action="<?php echo base_url() ?>lien-he" id="contact" method="post">
					...
					<h1 class="contact-title-page title-page">Liên hệ với chúng tôi</h1>
					...
					<div class="form-comment">
						...
						<button type="submit" class="btn-update-order btn-contact" >Gửi nhận xét</button>
		...
		<div class="col-md-4 col-12">
			...
			padding-left: 32px;
			">
			<h1 class="contact-title-page">Thông tin liên hệ</h1>
			<ul class="list-unstyled">
				<li class="clearfix">
					<i class="fa fa-map-marker fa-1x" style="color:#0f9ed8; padding: 20px; "></i>
					<span style="color: black"> Số 2 Trường Sa, Bình Thạnh, Hồ Chí Minh </span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
                    <span style="color: black"><a href="tel:0326848776">0326.848.776</a> </span>
				</li>
				<li class="clearfix">
