					...
					<div class="box" id="view">
						<div class="box-body">
                            ...
                            <div class="option-product-list">
                                <div data-option="1" class="row option-product-item">
                                    <div class="col-md-5">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Chiều dài (cm)</label>
                                                    <input type="number" required name="option-dai-product-1" class="form-control"  min="10" max="999">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" required name="option-rong-product-1" class="form-control"  min="10" max="999">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" required name="option-cao-product-1" class="form-control" min="10" max="999">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" required name="option-gia-product-1" class="form-control" min="10">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <a class="btn btn-warning remove-option" data-option="1">Xóa</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
