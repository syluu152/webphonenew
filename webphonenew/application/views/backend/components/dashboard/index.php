...
<div class="content-wrapper">
  ...
  <section id="print-doanh-thu" class="content">
    <div class="row">
      <!-- /.col (LEFT) -->
      <div class="col-md-12">
        <!-- LINE CHART -->
    ...
    <div class="text-center mb-3"><button onclick="printDiv()" class="btn btn-print-doanh-thu btn-primary ml-3">In doanh thu</button></div>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
  <script>
   ...
   function printDiv()
   {
       ...
       var divToPrint= document.getElementById('print-doanh-thu');
