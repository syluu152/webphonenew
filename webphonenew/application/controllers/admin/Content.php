...
class Content extends CI_Controller {
	...
	public function insert()
	{
		...
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->session->set_userdata('success', 'Thêm bài viết thành công');
	...
	public function update($id)
	{
		...
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->session->set_userdata('success', 'Cập nhật bài viết thành công');
			redirect('admin/content/','refresh');
		} 
	...
	public function status($id)
	{
		...
		$this->Mcontent->content_update($mydata, $id);
		$this->session->set_userdata('success', 'Cập nhật viết thành công');
		redirect('admin/content/','refresh');
	}
	...
	public function trash($id)
	{
		...
		$this->Mcontent->content_update($mydata, $id);
		$this->session->set_userdata('success', 'Xóa bài viết vào thùng rác thành công');
		redirect('admin/content','refresh');
	}
	...
	public function restore($id)
	{
		...
		$this->session->set_userdata('success', 'Khôi phục bài viết thành công');
		redirect('admin/content/recyclebin','refresh');
	}
	public function delete($id)
	{
		$this->Mcontent->content_delete($id);
		$this->session->set_userdata('success', 'Xóa bài viết thành công');
		redirect('admin/content/recyclebin','refresh');
	}
