...
class Contact extends CI_Controller {
    ...
    public function delete($id)
	{
		...
		$this->session->set_userdata('success', 'Xóa thành công');
	...
	public function trash($id)
	{
		...
		$this->Mcontact->contact_update($mydata,$id);
		$this->session->set_userdata('success', 'Xóa vào thùng rác thành công');
		redirect('admin/contact','refresh');
	}
	...
	public function restore($id)
	{
		...
		$this->session->set_userdata('success', 'Khôi phục thành công');
		redirect('admin/contact/recyclebin','refresh');
	}
