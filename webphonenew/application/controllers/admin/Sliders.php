...
class Sliders extends CI_Controller {
	...
	public function insert()
	{
		...
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->session->set_userdata('success', 'Thêm slider thành công');
	...
	public function update($id)
	{
		...
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->session->set_userdata('success', 'Cập nhật slider thành công');
			redirect('admin/sliders/','refresh');
		} 
	...
	public function trash($id)
	{
		...
		$this->Msliders->slider_update($mydata, $id);
		$this->session->set_userdata('success', 'Xóa slider vào thùng rác thành công');
		redirect('admin/sliders','refresh');
	}
	...
	public function restore($id)
	{
		...
		$this->session->set_userdata('success', 'Khôi phục slider thành công');
	...
	public function delete($id)
	{
		...
		$this->session->set_userdata('success', 'Xóa slider thành công');
		redirect('admin/sliders/recyclebin','refresh');
	}
