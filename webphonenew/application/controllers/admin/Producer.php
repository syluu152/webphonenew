...
class Producer extends CI_Controller {
	...
	public function insert(){
		...
		if ($this->form_validation->run() == TRUE){
			...
			$this->session->set_userdata('success', 'Thêm nhà cung cấp thành công');
	...
	public function update($id){
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$this->session->set_userdata('success', 'Cập nhật nhà cung cấp thành công');
			redirect('admin/producer/','refresh');
		} 
	...
	public function trash($id){
		...
		$this->Mproducer->producer_update($mydata, $id);
		$this->session->set_userdata('success', 'Xóa nhà cung cấp vào thùng rác thành công');
		redirect('admin/producer','refresh');
	}
	...
	public function restore($id)
	{
		...
		$this->session->set_userdata('success', 'Khôi phục nhà cung cấp thành công');
		redirect('admin/producer/recyclebin','refresh');
	}
	public function delete($id)
	{
		$this->Mproducer->producer_delete($id);
		$this->session->set_userdata('success', 'Xóa nhà cung cấp thành công');
		redirect('admin/producer/recyclebin','refresh');
	}
