...
class Coupon extends CI_Controller {
	...
	public function insert()
	{
		...
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->session->set_userdata('success', 'Thêm mã giảm giá thành công');
	...
	public function update($id)
	{
		...
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->session->set_userdata('success', 'Cập nhật mã giảm giá thành công');
			redirect('admin/coupon/','refresh');
		} 
	...
	public function status($id)
	{
		...
		$this->Mcoupon->coupon_update($mydata, $id);
		$this->session->set_userdata('success', 'Cập nhật trạng thái thành công');
		redirect('admin/coupon/','refresh');
	}
	...
	public function trash($id)
	{
		...
		$this->Mcoupon->coupon_update($mydata, $id);
		$this->session->set_userdata('success', 'Xóa mã giảm giá vào thùng rác thành công');
		redirect('admin/coupon','refresh');
	}
	...
	public function restore($id)
	{
		...
		$this->session->set_userdata('success', 'Khôi phục mã giảm giá thành công');
		redirect('admin/coupon/recyclebin','refresh');
	}
	public function delete($id)
	{
		$this->Mcoupon->coupon_delete($id);
		$this->session->set_userdata('success', 'Xóa mã giảm giá thành công');
		redirect('admin/coupon/recyclebin','refresh');
	}
