...
class Configuration extends CI_Controller {
	...
	{
		$this->data['row']=$this->Mconfiguration->configuration_detail(1);
		...
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->Mconfiguration->configuration_update($mydata,1);
			$this->session->set_userdata('success', 'Cập nhật Cấu hình thành công');
