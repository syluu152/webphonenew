					...
					<div class="box" id="view">
						<div class="box-body">
							<div class="col-md-9">
                                ...
                                <div class="option-product-list">
                                    <?php
                                    $i = 1;
                                    foreach (json_decode($row['option']) as $item):
                                            $option = explode('X',$item->value)
                                        ?>
                                    <div data-option="<?=$i?>" class="row option-product-item">
                                        <div class="col-md-5">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Chiều dài (cm)</label>
                                                        <input type="number" value="<?=$option[0]?>" required name="option-dai-product-<?=$i?>" class="form-control"  min="10" max="999">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="<?=$option[1]?>" required name="option-rong-product-<?=$i?>" class="form-control"  min="10" max="999">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="<?=$option[2]?>" required name="option-cao-product-<?=$i?>" class="form-control" min="10" max="999">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="<?=$item->price?>" required name="option-gia-product-<?=$i?>" class="form-control" min="10">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <a class="btn btn-warning remove-option" data-option="<?=$i?>">Xóa</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php $i++;
                                ...
                                <input type="hidden" name="option-product" value="">
                                <div class="text-right">
                                    <button type="button" class="btn add-option-product btn-primary">Thêm kích thước</button>
                                </div>
								<div class="form-group">
